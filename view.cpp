...
View::View(QMainWindow *mainWindow)
{
    ...
    topWidgetSpacer = new QSpacerItem(150, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
    ...
    tasksSpacer = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);
    ...
    tasksScrollArea->setAlignment(Qt::AlignTop);
}
